<div id="rates-modal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="container">
    <div class="rates-lb">
      <button class="close" data-dismiss="modal">x</button>
      <div class="row">
        <div class="col-sm-4 col-md-4 col-lg-4">
          <h2 id="myModalLabel">Get Started, It's Easy!</h2>
          <div class="sub">
            <div>3.44%</div>
            <div>5 Year Fixed Closed</div>
          </div>
          <div class="less-space">
            <div class="rate-details">Rate Details</div>
            <div class="table-wrapper">
              <table class="table">
                <tbody>
                  <tr>
                    <td>Rate Hold <span class="tool-tip">?</span></td>
                    <td>30 days</td>
                  </tr>
                  <tr>
                    <td>Increase Monthly Payment By <span class="tool-tip">?</span></td>
                    <td>20%</td>
                  </tr>
                  <tr>
                    <td>Lump Sum as a % of Mortgage Value <span class="tool-tip">?</span></td>
                    <td>20%</td>
                  </tr>
                </tbody>
              </table>
          ...
          <img src="<?php echo THEME_DIR?>/images/rates-1.png">
        </div>
            ...
            <div class="row">
              <form class="form-horizontal" role="form">
                ...
                <fieldset>
                  ...
                  <button class="btn green-gradient">Get This Rate!</button>
                </fieldset>
              </form>
            </div>
          </div>
